...
class Infiltration implements Story {
    ...
    public void play() {
        ...
        System.out.println("Concentrating hard on the appearance of wings, a pair identical to the demon's you had seen moments before sprout out your back");
        System.out.println("The cloaks appearance changes to accommodate the new appendages, and you take to the sky, flying as if you had been doing so since you were born");
